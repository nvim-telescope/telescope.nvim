...
describe("transform_path", function()
  ...
  it("handles 'reverse' path_display", function()
    assert_path("reverse", new_relpath "init.lua", new_relpath "init.lua")
    assert_path("reverse", new_relpath "lua/telescope/init.lua", new_relpath "init.lua telescope/lua/")
  end)
end)
