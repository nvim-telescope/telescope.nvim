...
builtin.live_grep = files.live_grep
...
---@field additional_args function: function(opts) which returns a table of additional arguments to be passed on
builtin.grep_string = files.grep_string
...
---@field search_dirs table: directory/directories to search in
builtin.find_files = files.find_files
...
---@field hidden boolean: determines whether to show hidden files or not (default is false)
builtin.file_browser = files.file_browser
...
builtin.treesitter = files.treesitter

--- Live fuzzy search inside of the currently open buffer
---@param opts table: options to pass to the picker
builtin.current_buffer_fuzzy_find = files.current_buffer_fuzzy_find
...
builtin.tags = files.tags

--- Lists all of the tags for the currently open buffer, with a preview
---@param opts table: options to pass to the picker
builtin.current_buffer_tags = files.current_buffer_tags
...
builtin.git_commits = git.commits
...
builtin.git_bcommits = git.bcommits
...
---@param opts table: options to pass to the picker
builtin.git_branches = git.branches
...
---@param opts table: options to pass to the picker
builtin.builtin = internal.builtin

--- Use the telescope...
---@param opts table: options to pass to the picker
builtin.planets = internal.planets
...
---@param opts table: options to pass to the picker
builtin.command_history = internal.command_history
...
---@param opts table: options to pass to the picker
builtin.search_history = internal.search_history
...
builtin.resume = internal.resume
...
builtin.lsp_definitions = lsp.definitions
...
builtin.lsp_document_symbols = lsp.document_symbols
...
---@field symbols string|table: filter results by symbol kind(s)
builtin.lsp_workspace_symbols = lsp.workspace_symbols

--- Dynamically lists LSP for all workspace symbols
--- - Default keymaps:
---   - `<C-l>`: show autocompletion menu to prefilter your query by type of symbol you want to see (i.e. `:variable:`)
---@param opts table: options to pass to the picker
builtin.lsp_dynamic_workspace_symbols = lsp.dynamic_workspace_symbols
...
builtin.lsp_document_diagnostics = lsp.diagnostics
...
---@field no_sign bool: hide LspDiagnosticSigns from Results (default is false)
---@field line_width number: set length of diagnostic entry text in Results
builtin.lsp_workspace_diagnostics = lsp.workspace_diagnostics
