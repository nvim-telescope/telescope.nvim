...
builtin.menu = require('telescope.builtin.menu').menu
builtin.test_menu = require('telescope.builtin.menu').test_menu
builtin.Node = require('telescope.builtin.menu').Node
